...
class BaseField(object):
    ...
    def __init__(self, db_field=None, name=None, required=False, default=None,label=None,editable=True,
                 unique=False, unique_with=None, primary_key=False, validation=None,help_text='',
                 choices=None):
    ...
    def _validate(self, value):
        ...
        if self.choices is not None:
            ...
            if value not in choices:
                raise ValidationError("Value must be one of %s." % unicode(choices))
